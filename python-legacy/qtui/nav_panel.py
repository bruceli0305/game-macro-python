...
class NavPanel(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self._btn_cycle_editor = QPushButton("循环阶段编辑器", self)
        self._btn_cycle_editor.setIcon(icon_rotation)
        self._btn_cycle_editor.setCheckable(True)
        self._btn_cycle_editor.setStyleSheet("QPushButton { font-weight: bold; }")
        self._btn_cycle_editor.clicked.connect(lambda: self.page_selected.emit("cycle_editor"))
        layout.addWidget(self._btn_cycle_editor)
        ...
        self._btn_quick_start = QPushButton("快速开始向导", self)
        self._btn_quick_start.setIcon(icon_plugin)
        self._btn_quick_start.setCheckable(False)
        self._btn_quick_start.clicked.connect(
            lambda: self.plugin_action.emit("quick_start")
        )
        layout.addWidget(self._btn_quick_start)
    ...
    def set_active_page(self, key: str) -> None:
        ...
        if hasattr(self, "_btn_cycle_editor"):
            self._btn_cycle_editor.setChecked(key == "cycle_editor")
