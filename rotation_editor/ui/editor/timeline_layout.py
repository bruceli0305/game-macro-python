...
def build_timeline_layout(
    ...
    *,
    ...
    def build_row(track: Track, title_prefix: str, mode_id_for_track: str) -> Optional[TrackVisualSpec]:
        # 计算每个节点持续时间
        durations: List[int] = []
        for n in track.nodes:
            durations.append(_node_duration_ms(n, skills_by_id))
